...
class PasswordVerificationMixin(object):
    def clean(self):
        ...
        if (password1 and password2) and password1 != password2:
            self.add_error(
                'password2', _("Debe escribir la misma contraseña.")
            )
        return cleaned_data
...
class LoginForm(forms.Form):
    ...
    remember = forms.BooleanField(label=_("Recuérdame"),
                                  required=False)
    ...
    error_messages = {
        ...
        _("La dirección de correo electrónico y/o la contraseña no son correctas."),

        'username_password_mismatch':
        _("El nombre de usuario y/o contraseña que especificó no son correctos."),
    }
...
class BaseSignupForm(_base_signup_form_class()):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if email_required:
            ...
            self.fields['email'].label = ugettext("E-mail (opcional)")
...
class SignupForm(BaseSignupForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password1'] = PasswordField(label=_("Contraseña"))
